...
Пространства имен дают вам возможность синхронизироваться конкретное событие (например, `.off('click.menuOpening')`).
...
**Примечание:** Это можно сделать несколькими способами [в CSS](http://codepen.io/AllThingsSmitty/pen/KMPqoO), но в зависимости от того, что ваши потребности, зная, как сделать это в JQuery еще стоит.
