...
- [jQuery Tips Everyone Should Know ![Awesome](https://github.com/sindresorhus/awesome)](#jquery-tips-everyone-should-know-)
  - [Table of Contents](#table-of-contents)
  - [Tips](#tips)
    - [Use `noConflict()`](#use-noconflict)
    - [Checking If jQuery Loaded](#checking-if-jquery-loaded)
    - [Check Whether an Element Exists](#check-whether-an-element-exists)
    - [Use `.on()` Binding Instead of `.click()`](#use-on-binding-instead-of-click)
    - [Back to Top Button](#back-to-top-button)
    - [Preload Images](#preload-images)
    - [Checking If Images Are Loaded](#checking-if-images-are-loaded)
    - [Fix Broken Images Automatically](#fix-broken-images-automatically)
    - [Post a Form with AJAX](#post-a-form-with-ajax)
    - [Toggle Classes on Hover](#toggle-classes-on-hover)
    - [Disabling Input Fields](#disabling-input-fields)
    - [Stop the Loading of Links](#stop-the-loading-of-links)
    ...
    - [Open External Links in New Tab/Window](#open-external-links-in-new-tabwindow)
    - [Find Element By Text](#find-element-by-text)
    - [Trigger on Visibility Change](#trigger-on-visibility-change)
    - [AJAX Call Error Handling](#ajax-call-error-handling)
    - [Chain Plugin Calls](#chain-plugin-calls)
    - [Sort List Items Alphabetically](#sort-list-items-alphabetically)
